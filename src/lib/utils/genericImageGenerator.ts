  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 500" width="800" height="500">
    <defs>
      <linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" stop-color="#00140F"/>
        <stop offset="40%" stop-color="#00251B"/>
        <stop offset="100%" stop-color="#001A13"/>
      </linearGradient>
      <linearGradient id="accent" x1="0%" y1="0%" x2="100%" y2="0%">
        <stop offset="0%" stop-color="#00E878"/>
        <stop offset="50%" stop-color="#55FF78"/>
        <stop offset="100%" stop-color="#00A855"/>
      </linearGradient>
      <linearGradient id="carBody" x1="0%" y1="0%" x2="100%" y2="0%">
        <stop offset="0%" stop-color="#002B1F"/>
        <stop offset="50%" stop-color="#003D2D"/>
    ...
    <circle cx="400" cy="200" r="280" fill="#00251B" opacity="0.4"/>
    
    <!-- Grid pattern -->
    <path d="M0 400 H800 M0 430 H800 M0 455 H800 M0 475 H800" stroke="#003D2D" stroke-width="1" opacity="0.3"/>
    ...
    <!-- Headlight glow -->
    <ellipse cx="140" cy="330" rx="20" ry="10" fill="#00E878" opacity="0.6"/>
    <ellipse cx="135" cy="330" rx="10" ry="5" fill="#F2F7F3"/>
    
    <!-- Wheels -->
    <circle cx="230" cy="340" r="45" fill="#00140F" stroke="#8EA79C" stroke-width="8"/>
    <circle cx="230" cy="340" r="20" fill="#002B1F"/>
    <circle cx="610" cy="340" r="45" fill="#00140F" stroke="#8EA79C" stroke-width="8"/>
    <circle cx="610" cy="340" r="20" fill="#002B1F"/>

    <!-- Speed Accent Line -->
    <path d="M 80,360 L 720,360" stroke="url(#accent)" stroke-width="4" stroke-linecap="round"/>

    <!-- Yardly Automotives Model Badge Box -->
    <rect x="200" y="45" width="400" height="90" rx="16" fill="#001F17" stroke="rgba(180,255,210,0.18)" stroke-width="2" opacity="0.9"/>
    ...
    <text x="400" y="435" fill="#001A13" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" font-size="11" font-weight="800" letter-spacing="1" text-anchor="middle">
