...
const MODEL_TO_CLUSTER: Array<{ patterns: string[]; clusterId: string }> = [
  ...
  { patterns: ['s400h lwb', 's400h'], clusterId: 'cluster_2014_mercedes_benz_s400h_lwb' },
  ...
  { patterns: ['probox silver', 'probox 2017', 'probox'], clusterId: 'cluster_toyota_probox_silver' },
  ...
  { patterns: ['evoque r-dynamic', 'evoque r dynamic', 'evoque'], clusterId: 'cluster_range_rover_evoque' },
  ...
  { patterns: ['bmw z4 convertible', 'sdrive 20i', 'z4 2020', 'z4'], clusterId: 'cluster_bmw_z4_convertible_sdrive_20i' },
  { patterns: ['rolls royce ghost', 'ghost series i', 'ghost'], clusterId: 'cluster_2015_rolls_royce_ghost_series_i' },
  { patterns: ['f10 520i', '520i m sport', 'f10', '520i'], clusterId: 'cluster_bmw_f10_520i_m_sport' },
  ...
  { patterns: ['e46 318i', 'e46', '318i'], clusterId: 'cluster_bmw_e46_318i' },
  { patterns: ['accord ex-l', 'accord'], clusterId: 'cluster_2014_honda_accord_ex_l' },
  { patterns: ['crown rs', 's220', 'crown 15th', 'crown'], clusterId: 'cluster_2018_toyota_crown_rs_s220_15th_gen' },
  ...
  { patterns: ['outback', 'subaru outback'], clusterId: 'cluster_subaru_outback' },
  { patterns: ['xc60 t5', 'xc60 inscription'], clusterId: 'cluster_2017_volvo_xc60_t5_inscription' },
  { patterns: ['volvo xc60', 'xc60'], clusterId: 'cluster_volvo_xc60' },
  { patterns: ['a5 s-line', 'a5 b9', 'a5'], clusterId: 'cluster_audi_a5_s_line_b9' },
  { patterns: ['x6 35d', 'x6 30d'], clusterId: 'cluster_2020_bmw_x6_35d' },
  { patterns: ['bmw x6', 'x6'], clusterId: 'cluster_bmw_x6' },
  { patterns: ['golf r', 'mk7.5'], clusterId: 'cluster_2016_vw_golf_r_mk7_5' },
  { patterns: ['volkswagen golf', 'golf'], clusterId: 'cluster_volkswagen_golf' },
  { patterns: ['jincheng 150', 'jincheng'], clusterId: 'cluster_jincheng_150' },
  { patterns: ['demio', 'mazda2'], clusterId: 'cluster_mazda_demio' },
  { patterns: ['gle 53', 'gle 53 coupe'], clusterId: 'cluster_mercedes_amg_gle_53_coupe' },
  { patterns: ['patrol', 'y62'], clusterId: 'cluster_nissan_patrol_y62' },
  { patterns: ['land cruiser 300', 'land cruiser zx', 'landcruiser 300'], clusterId: 'cluster_toyota_landcruiser' },
  { patterns: ['prado', 'land cruiser 200', 'land cruiser'], clusterId: 'cluster_toyota_land_cruiser_200' },
  { patterns: ['mercedes benz c200', 'c200'], clusterId: 'cluster_mercedes_benz_c200' },
  { patterns: ['c-class', 'c300', 'c63'], clusterId: 'cluster_mercedes_benz_c_class' },
  ...
  { patterns: ['rav4 older', 'rav4 2012', 'rav4 2015'], clusterId: 'cluster_toyota_rav4_older' },
  { patterns: ['rav4', 'rav 4'], clusterId: 'cluster_toyota_rav4_newer' },
  { patterns: ['s-class', 's500', 's350', 'w223', 's400'], clusterId: 'cluster_mercedes_benz_s_class' },
  { patterns: ['q8 2021', 'audi q8 2021'], clusterId: 'cluster_audi_q8_2021' },
  { patterns: ['q8', 'audi q8'], clusterId: 'cluster_audi_q8' },
  { patterns: ['hiace', 'super gl'], clusterId: 'cluster_toyota_hiace' },
  { patterns: ['supra', 'toyota supra'], clusterId: 'cluster_toyota_supra' },
  { patterns: ['noah', 'toyota noah'], clusterId: 'cluster_toyota_noah' },
  { patterns: ['fit', 'vitz'], clusterId: 'cluster_honda_fit_rs' },
  ...
  { patterns: ['polo', 'volkswagen polo'], clusterId: 'cluster_volkswagen_polo' },
  { patterns: ['ranger', 'ford ranger'], clusterId: 'cluster_ford_ranger' }
];
