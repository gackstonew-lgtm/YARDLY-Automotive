...
export const AuctionMarketplace: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F4F8F6] dark:bg-[#001A13] text-[#0F241C] dark:text-[#F2F7F3] flex flex-col font-sans selection:bg-[#00E878] selection:text-[#001A13]">
      ...
      {/* Hero Header */}
      <div className="bg-gradient-to-r from-[#EDF5F1] via-[#E4EFEA] to-[#DBE9E2] dark:from-[#00140F] dark:via-[#00251B] dark:to-[#001F17] border-b border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.12)] text-[#0F241C] dark:text-[#F2F7F3] py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#009E52]/10 dark:bg-[#00E878]/10 border border-[#009E52]/20 dark:border-[#00E878]/30 text-xs font-extrabold uppercase tracking-wider text-[#009E52] dark:text-[#00E878] mb-3">
              <Gavel className="w-4 h-4 text-[#009E52] dark:text-[#00E878]" />
          ...
          <div className="flex items-center gap-3">
            <div className="bg-white dark:bg-[#001F17] backdrop-blur-md px-5 py-3 rounded-2xl border border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.15)] text-center shadow-sm">
              <div className="text-2xl font-black text-[#009E52] dark:text-[#00E878]">{auctions.filter(a => a.status === 'live' || a.status === 'ending_soon').length}</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-[calc(7rem+env(safe-area-inset-bottom,0px))] md:pb-8 w-full flex-grow">
        ...
        {/* Status Filter Tabs */}
        <div className="flex flex-wrap items-center gap-2 border-b border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.12)] pb-4 mb-8">
            ...
            <button
              ...
              className={`px-5 py-2 rounded-full text-xs font-extrabold uppercase tracking-wider transition-all cursor-pointer ${
                activeTab === tab
                  ...
                  : 'bg-white dark:bg-[#001F17] text-[#355347] dark:text-[#8EA79C] border border-[rgba(0,60,40,0.12)] dark:border-[rgba(180,255,210,0.2)] hover:border-[#009E52] dark:hover:border-[#00E878] hover:text-[#0F241C] dark:hover:text-[#F2F7F3]'
              }`}
            >
        ...
        {filteredAuctions.length === 0 ? (
          <div className="bg-white dark:bg-[#00251B]/90 backdrop-blur-md rounded-3xl border border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.15)] p-12 text-center space-y-3 shadow-sm">
            <Gavel className="w-12 h-12 text-[#009E52] dark:text-[#00E878] mx-auto opacity-40" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredAuctions.map((auc) => {
              ...
              return (
                <div key={auc.id} className="group bg-white dark:bg-[#00251B]/90 backdrop-blur-md rounded-3xl border border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.15)] shadow-sm dark:shadow-glass hover:shadow-lg dark:hover:shadow-glass-hover hover:border-[#009E52]/40 dark:hover:border-[#00E878]/40 transition-all duration-300 overflow-hidden flex flex-col hover-lift">
                  
                  {/* Image & Status Badge */}
                  <div className="relative h-48 bg-[#EDF5F1] dark:bg-[#001711] overflow-hidden">
                    <img
                      src={primaryImg}
                    ...
                    {auc.status !== 'ended' && (
                      <div className="absolute bottom-3 right-3 bg-white/90 dark:bg-[#00140F]/90 backdrop-blur-md text-[#0F241C] dark:text-[#F2F7F3] text-[11px] font-mono font-bold px-3 py-1 rounded-full flex items-center gap-1.5 shadow border border-[rgba(0,60,40,0.1)] dark:border-[rgba(180,255,210,0.15)]">
                        <Clock className="w-3.5 h-3.5 text-[#009E52] dark:text-[#00E878]" />
                  ...
                  <div className="p-5 flex-grow flex flex-col justify-between space-y-4">
                    <div>
                      ...
                      <h3 className="text-lg font-black text-[#0F241C] dark:text-[#F2F7F3] mt-0.5 group-hover:text-[#009E52] dark:group-hover:text-[#00E878] transition-colors">
                        {v ? `${v.make} ${v.model} ${v.variant || ''}` : `Auction #${auc.id}`}
                      </h3>
                    </div>

                    <div className="p-3.5 rounded-2xl bg-[#F4F8F6] dark:bg-[#001F17] border border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.12)] flex items-center justify-between">
                      <div>
                        <div className="text-[10px] font-bold text-[#355347] dark:text-[#8EA79C] uppercase">Current High Bid</div>
                        <div className="text-xl font-black text-[#009E52] dark:text-[#00E878]">
      ...
      {selectedAuction && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white dark:bg-[#00251B] rounded-3xl border border-[rgba(0,60,40,0.12)] dark:border-[rgba(180,255,210,0.2)] max-w-2xl w-full p-6 sm:p-8 shadow-2xl space-y-6 relative my-8 text-[#0F241C] dark:text-[#F2F7F3]">
            
            <button
              onClick={() => setSelectedAuction(null)}
              className="absolute top-4 right-4 w-8 h-8 rounded-full bg-[#F4F8F6] dark:bg-[#001F17] border border-[rgba(0,60,40,0.12)] dark:border-[rgba(180,255,210,0.2)] text-[#0F241C] dark:text-[#F2F7F3] font-bold flex items-center justify-center hover:bg-[#E4EFEA] dark:hover:bg-[#003D2D] transition-colors cursor-pointer"
            >
              ✕
            </button>
            ...
            {/* Bidding Summary */}
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 p-4 rounded-2xl bg-[#F4F8F6] dark:bg-[#001F17] border border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.12)]">
              <div>
                <div className="text-[10px] font-bold text-[#355347] dark:text-[#8EA79C] uppercase">Current High Bid</div>
                <div className="text-lg font-black text-[#009E52] dark:text-[#00E878]">KES {selectedAuction.current_bid.toLocaleString()}</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-sm font-extrabold text-[#009E52] dark:text-[#00E878]">
            ...
            {successMsg && (
              <div className="p-3.5 rounded-xl bg-[#E0F8EC] dark:bg-[#00E878]/15 border border-[#009E52]/30 dark:border-[#00E878]/30 text-xs font-semibold text-[#009E52] dark:text-[#00E878] flex items-center gap-2">
            ...
            <div>
              ...
              <div className="max-h-40 overflow-y-auto space-y-2 border-t border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.12)] pt-2">
                {selectedAuction.bids && selectedAuction.bids.length > 0 ? (
                  selectedAuction.bids.map((b) => (
                    <div key={b.id} className="p-2.5 rounded-xl bg-[#F4F8F6] dark:bg-[#001F17] border border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.1)] flex items-center justify-between text-xs">
                      <div>
                      ...
                      <span className="font-mono font-black text-[#009E52] dark:text-[#00E878]">KES {b.amount.toLocaleString()}</span>
                    </div>
                  ))
                ) : (
