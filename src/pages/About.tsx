    ...
    <div className="min-h-screen bg-[#001A13] text-[#F2F7F3] flex flex-col pb-[calc(7rem+env(safe-area-inset-bottom,0px))] md:pb-8 font-sans">
      ...
      <div className="bg-gradient-to-b from-[#00251B] via-[#001F17] to-[#001A13] border-b border-[rgba(180,255,210,0.12)] text-[#F2F7F3] py-14 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <p className="text-sm sm:text-base text-[#8EA79C] max-w-2xl mx-auto leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full flex-grow space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#00251B]/90 backdrop-blur-md rounded-3xl p-6 border border-[rgba(180,255,210,0.12)] shadow-xl hover:border-[#00E878]/40 hover:shadow-[0_12px_40px_-8px_rgba(0,232,120,0.15)] transition-all space-y-3">
            <div className="w-10 h-10 rounded-2xl bg-[#003D2D]/60 border border-[rgba(180,255,210,0.15)] text-[#00E878] flex items-center justify-center font-black">
              <ShieldCheck className="w-5 h-5 text-[#00E878]" />
            </div>
            <h3 className="text-lg font-black text-[#F2F7F3]">Quality-Focused</h3>
          ...
          <div className="bg-[#00251B]/90 backdrop-blur-md rounded-3xl p-6 border border-[rgba(180,255,210,0.12)] shadow-xl hover:border-[#00E878]/40 hover:shadow-[0_12px_40px_-8px_rgba(0,232,120,0.15)] transition-all space-y-3">
            <div className="w-10 h-10 rounded-2xl bg-[#003D2D]/60 border border-[rgba(180,255,210,0.15)] text-[#00E878] flex items-center justify-center font-black">
              <Zap className="w-5 h-5 text-[#00E878]" />
            </div>
            <h3 className="text-lg font-black text-[#F2F7F3]">Customer-First Service</h3>
            <p className="text-xs text-[#8EA79C] leading-relaxed">
          ...
          <div className="bg-[#00251B]/90 backdrop-blur-md rounded-3xl p-6 border border-[rgba(180,255,210,0.12)] shadow-xl hover:border-[#00E878]/40 hover:shadow-[0_12px_40px_-8px_rgba(0,232,120,0.15)] transition-all space-y-3">
            <div className="w-10 h-10 rounded-2xl bg-[#003D2D]/60 border border-[rgba(180,255,210,0.15)] text-[#00E878] flex items-center justify-center font-black">
              <Award className="w-5 h-5 text-[#00E878]" />
            </div>
            <h3 className="text-lg font-black text-[#F2F7F3]">Transparent Information</h3>
            <p className="text-xs text-[#8EA79C] leading-relaxed">
        ...
        {/* Contact Info Card */}
        <div className="bg-[#00251B]/90 backdrop-blur-md rounded-3xl p-8 border border-[rgba(180,255,210,0.12)] shadow-2xl max-w-3xl mx-auto space-y-6 text-center">
          <div className="space-y-2">
            <h2 className="text-2xl font-black text-[#F2F7F3]">Let's Find the Right Vehicle for You</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs text-[#F2F7F3] pt-2">
            <div className="p-4 rounded-2xl bg-[#001F17] border border-[rgba(180,255,210,0.12)] space-y-1">
              <MapPin className="w-5 h-5 text-[#00E878] mx-auto mb-1" />
              <div className="font-bold">{siteConfig.contact.address}</div>
            </div>
            <a href={`tel:${siteConfig.contact.phone}`} className="p-4 rounded-2xl bg-[#001F17] border border-[rgba(180,255,210,0.12)] space-y-1 hover:border-[#00E878] transition-colors">
              <Phone className="w-5 h-5 text-[#00E878] mx-auto mb-1" />
              <div className="font-bold text-[#00E878]">{siteConfig.contact.phone}</div>
            </a>
            <a href={`mailto:${siteConfig.contact.email}`} className="p-4 rounded-2xl bg-[#001F17] border border-[rgba(180,255,210,0.12)] space-y-1 hover:border-[#00E878] transition-colors">
              <Mail className="w-5 h-5 text-[#00E878] mx-auto mb-1" />
              <div className="font-bold text-[#00E878] truncate">{siteConfig.contact.email}</div>
            </a>
          </div>
        </div>
