              ...
              <div className="relative rounded-3xl overflow-hidden bg-[#00251B] border border-[rgba(180,255,210,0.18)] p-3 shadow-2xl group hover-lift">
                <div className="relative h-72 sm:h-96 rounded-2xl overflow-hidden bg-[#001711]">
                  ...
                  <div className="absolute top-4 left-4 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#001A13]/85 backdrop-blur-md border border-[rgba(180,255,210,0.25)] text-xs font-black text-[#00E878]">
                    <Tag className="w-3.5 h-3.5 text-[#00E878]" />
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-[#001A13]/95 backdrop-blur-md p-4 rounded-xl border border-[rgba(180,255,210,0.15)] flex items-center justify-between">
                    <div>
                      <div className="text-xs font-extrabold text-[#F2F7F3]">Browse Verified Stock</div>
                      <div className="text-[11px] text-[#8EA79C]">Over 500+ Japanese & European Models</div>
                    </div>
                    <Link to="/buy">
          ...
          <div className="lg:col-span-6 space-y-6 order-1 lg:order-2">
            <Reveal direction="right">
              ...
              <div className="space-y-3 pt-2">
                <div className="flex items-start gap-3 bg-[#00251B]/50 p-3 rounded-xl border border-[rgba(180,255,210,0.08)]">
                  <CheckCircle2 className="w-5 h-5 text-[#00E878] shrink-0 mt-0.5" />
                  <div>
                    <h4 className="text-xs font-bold text-[#F2F7F3]">For Buyers</h4>
                    <p className="text-[11px] text-[#8EA79C]">Verified vehicle photos, complete specs, mileage history, and instant reservation deposits.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 bg-[#00251B]/50 p-3 rounded-xl border border-[rgba(180,255,210,0.08)]">
                  <CheckCircle2 className="w-5 h-5 text-[#00E878] shrink-0 mt-0.5" />
                  <div>
                    <h4 className="text-xs font-bold text-[#F2F7F3]">For Sellers & Dealerships</h4>
                    <p className="text-[11px] text-[#8EA79C]">List private cars or fleet stock to reach verified buyers across Kenya quickly.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-4">
                ...
                <Link to="/sell">
                  <Button variant="outline" className="font-extrabold bg-[#00251B] border-[rgba(180,255,210,0.2)] text-[#F2F7F3] hover:border-[#00E878] hover:text-[#00E878] flex items-center gap-2">
