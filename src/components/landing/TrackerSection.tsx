              ...
              <div className="relative rounded-3xl overflow-hidden bg-white dark:bg-[#00251B] border border-[rgba(0,60,40,0.12)] dark:border-[rgba(180,255,210,0.18)] p-3 shadow-lg dark:shadow-2xl group hover-lift">
                <div className="relative h-72 sm:h-96 rounded-2xl overflow-hidden bg-[#EBF2EE] dark:bg-[#001711]">
                  ...
                  <div className="absolute top-4 left-4 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/90 dark:bg-[#001A13]/85 backdrop-blur-md border border-[rgba(0,60,40,0.15)] dark:border-[rgba(180,255,210,0.25)] text-xs font-black text-[#009E52] dark:text-[#00E878]">
                    <Cpu className="w-3.5 h-3.5 text-[#009E52] dark:text-[#00E878]" />
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-white/95 dark:bg-[#001A13]/95 backdrop-blur-md p-4 rounded-xl border border-[rgba(0,60,40,0.1)] dark:border-[rgba(180,255,210,0.15)] flex items-center justify-between">
                    <div>
                      <div className="text-xs font-extrabold text-[#0F241C] dark:text-[#F2F7F3]">Vehicle Telemetry & GPS</div>
                      <div className="text-[11px] text-[#5F7E71] dark:text-[#8EA79C]">Mobile app monitoring & instant alerts</div>
                    </div>
                    <Link to="/trackers">
            ...
            <Reveal direction="right">
              ...
              <div className="space-y-3 pt-2">
                <div className="bg-white/80 dark:bg-[#00251B]/60 p-3.5 rounded-2xl border border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.08)] flex items-center gap-3">
                  <Smartphone className="w-5 h-5 text-[#009E52] dark:text-[#00E878] shrink-0" />
                  <div className="text-xs text-[#5F7E71] dark:text-[#8EA79C]"><strong className="text-[#0F241C] dark:text-[#F2F7F3]">Real-Time GPS Tracking:</strong> Monitor vehicle location, route history, and playback from your smartphone.</div>
                </div>

                <div className="bg-white/80 dark:bg-[#00251B]/60 p-3.5 rounded-2xl border border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.08)] flex items-center gap-3">
                  <Bell className="w-5 h-5 text-[#009E52] dark:text-[#00E878] shrink-0" />
                  <div className="text-xs text-[#5F7E71] dark:text-[#8EA79C]"><strong className="text-[#0F241C] dark:text-[#F2F7F3]">Instant Notifications:</strong> Geofencing alerts, engine on/off triggers, and speed warning reports.</div>
                </div>

                <div className="bg-white/80 dark:bg-[#00251B]/60 p-3.5 rounded-2xl border border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.08)] flex items-center gap-3">
                  <ShieldCheck className="w-5 h-5 text-[#009E52] dark:text-[#00E878] shrink-0" />
                  <div className="text-xs text-[#5F7E71] dark:text-[#8EA79C]"><strong className="text-[#0F241C] dark:text-[#F2F7F3]">Concealed Installation:</strong> Clean, non-intrusive electrical wiring by certified automotive technicians.</div>
                </div>
              </div>
