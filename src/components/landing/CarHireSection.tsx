              ...
              <div className="relative rounded-3xl overflow-hidden bg-[#00251B] border border-[rgba(180,255,210,0.18)] p-3 shadow-2xl group hover-lift">
                <div className="relative h-72 sm:h-96 rounded-2xl overflow-hidden bg-[#001711]">
                  ...
                  <div className="absolute top-4 left-4 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#001A13]/85 backdrop-blur-md border border-[rgba(180,255,210,0.25)] text-xs font-black text-[#00E878]">
                    <Key className="w-3.5 h-3.5 text-[#00E878]" />
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-[#001A13]/95 backdrop-blur-md p-4 rounded-xl border border-[rgba(180,255,210,0.15)] flex items-center justify-between">
                    <div>
                      <div className="text-xs font-extrabold text-[#F2F7F3]">SUVs, Sedans & 4x4s</div>
                      <div className="text-[11px] text-[#8EA79C]">Self-drive and chauffeur options</div>
                    </div>
                    <Link to="/car-hire">
            ...
            <Reveal direction="right">
              ...
              <div className="space-y-3 pt-2">
                <div className="bg-[#00251B]/60 p-3.5 rounded-2xl border border-[rgba(180,255,210,0.08)] flex items-center gap-3">
                  <Calendar className="w-5 h-5 text-[#00E878] shrink-0" />
                  <div className="text-xs text-[#8EA79C]"><strong className="text-[#F2F7F3]">Flexible Durations:</strong> Daily, weekly, and monthly corporate leasing options.</div>
                </div>

                <div className="bg-[#00251B]/60 p-3.5 rounded-2xl border border-[rgba(180,255,210,0.08)] flex items-center gap-3">
                  <MapPin className="w-5 h-5 text-[#00E878] shrink-0" />
                  <div className="text-xs text-[#8EA79C]"><strong className="text-[#F2F7F3]">Convenient Pickup:</strong> Station pickups in Nairobi, Mombasa, Nakuru, and Eldoret.</div>
                </div>

                <div className="bg-[#00251B]/60 p-3.5 rounded-2xl border border-[rgba(180,255,210,0.08)] flex items-center gap-3">
                  <ShieldCheck className="w-5 h-5 text-[#00E878] shrink-0" />
                  <div className="text-xs text-[#8EA79C]"><strong className="text-[#F2F7F3]">Maintained Fleet:</strong> Rigorously serviced vehicles with 24/7 roadside assistance.</div>
                </div>
              </div>
