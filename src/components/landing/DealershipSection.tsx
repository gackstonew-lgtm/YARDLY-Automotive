          ...
          <div className="lg:col-span-6 space-y-6">
            <Reveal direction="left">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#EBF2EE] dark:bg-[#002B1F] border border-[rgba(0,60,40,0.12)] dark:border-[rgba(180,255,210,0.15)] text-xs font-extrabold uppercase tracking-wider text-[#009E52] dark:text-[#00E878]">
                <Building className="w-3.5 h-3.5 text-[#009E52] dark:text-[#00E878]" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <div className="bg-[#F4F8F6] dark:bg-[#00251B]/70 p-4 rounded-2xl border border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.1)] space-y-1.5">
                  ...
                  <p className="text-[11px] text-[#5F7E71] dark:text-[#8EA79C]">Display high-resolution photos, spec sheets, and price points to qualified automotive buyers.</p>
                </div>

                <div className="bg-[#F4F8F6] dark:bg-[#00251B]/70 p-4 rounded-2xl border border-[rgba(0,60,40,0.08)] dark:border-[rgba(180,255,210,0.1)] space-y-1.5">
                  <div className="text-xs font-bold text-[#0F241C] dark:text-[#F2F7F3] flex items-center gap-1.5">
                    <Users className="w-4 h-4 text-[#009E52] dark:text-[#00E878]" />
                    <span>Dealer Management Portal</span>
                  </div>
                  <p className="text-[11px] text-[#5F7E71] dark:text-[#8EA79C]">Dedicated admin console to update listings, track buyer enquiries, and manage vehicle status.</p>
                </div>
              </div>
              ...
              <div className="relative rounded-3xl overflow-hidden bg-white dark:bg-[#00251B] border border-[rgba(0,60,40,0.12)] dark:border-[rgba(180,255,210,0.18)] p-3 shadow-lg dark:shadow-2xl group hover-lift">
                <div className="relative h-72 sm:h-96 rounded-2xl overflow-hidden bg-[#EBF2EE] dark:bg-[#001711]">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 bg-white/95 dark:bg-[#001A13]/95 backdrop-blur-md p-4 rounded-xl border border-[rgba(0,60,40,0.1)] dark:border-[rgba(180,255,210,0.15)] flex items-center justify-between">
                    <div>
                      <div className="text-xs font-extrabold text-[#0F241C] dark:text-[#F2F7F3]">Join Dealership Network</div>
                      <div className="text-[11px] text-[#5F7E71] dark:text-[#8EA79C]">Nairobi, Mombasa, Nakuru & Countrywide</div>
                    </div>
                    <Link to="/dealerships">
