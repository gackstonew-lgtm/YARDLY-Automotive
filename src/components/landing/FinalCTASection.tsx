...
export const FinalCTASection: React.FC = () => {
  return (
    <section className="py-16 sm:py-24 bg-white dark:bg-[#001711] relative overflow-hidden">
      {/* Background ambient lighting */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-[#009E52]/10 dark:bg-[#00E878]/10 rounded-full blur-[130px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <Reveal direction="up">
          <div className="rounded-3xl bg-gradient-to-r from-[#003426] via-[#004735] to-[#00251B] p-8 sm:p-14 text-[#F2F7F3] shadow-xl dark:shadow-2xl border border-[rgba(180,255,210,0.25)] relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3.5 shrink-0 w-full sm:w-auto justify-center">
              ...
              <Link to="/login" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="w-full sm:w-auto font-bold px-6 py-4 bg-white/10 dark:bg-[#00251B]/90 border-[rgba(180,255,210,0.25)] text-[#F2F7F3] hover:border-[#00E878] hover:text-[#00E878] flex items-center justify-center gap-2">
